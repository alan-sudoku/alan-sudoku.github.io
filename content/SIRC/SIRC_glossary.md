...
| $C_+$ | Positive channel (abstract) | The invariant content that survives audit — what the receiver reconstructs. At document level: [SIRC_principles.md](SIRC_principles.md) is the $C_+$ of the document pair. |
