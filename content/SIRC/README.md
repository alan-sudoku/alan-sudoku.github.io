...
**For adversarial readers:** attach [SIRC_principles_audit_prompt.md](SIRC_principles_audit_prompt.md) to SIRC_principles.md and run the prompts. The audit was live during development; the retraction log records how each attack resolved.
...
The audit prompt ([SIRC_principles_audit_prompt.md](SIRC_principles_audit_prompt.md)) is the activation path. Run it adversarially — the document has been attacked by the listed failure modes during development and the retraction log records what was found.
