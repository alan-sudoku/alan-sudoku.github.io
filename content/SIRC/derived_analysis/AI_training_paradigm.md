...
**Dependency on principles:** All claims trace to [SIRC_principles.md](SIRC_principles.md § $\mathsf{P1}$–§ $\mathsf{P4}$. No new principles are introduced. Claims not derivable from $\mathsf{P1}\text{–}\mathsf{P4}$ are marked *Conjecture*.
